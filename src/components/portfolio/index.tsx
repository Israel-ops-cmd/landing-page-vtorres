...
export function Portfolio() {
  const projects = [
    { id: 1, title: "Pórtico de Entrada - Município de Brejinho", image: imagem1 },
    { id: 2, title: "Quadra Poliesportiva - Colégio Over", image: imagem2 },
    { id: 3, title: "Calçamento e Infraestrutura Urbana - Brejinho", image: imagem3 },
    { id: 4, title: "Prefeitura Municipal de Curral de Cima", image: hero_pref },
  ]
